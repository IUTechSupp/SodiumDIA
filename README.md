...
**Issue #7:** [![Static Badge](https://img.shields.io/badge/%D0%9E%D1%82%D1%80%D0%B8%D1%81%D0%BE%D0%B2%D0%BA%D0%B0%20%D1%81%D1%82%D1%80%D0%BE%D0%BA%20%D1%80%D0%B0%D0%B7%D0%BB%D0%B8%D1%87%D0%BD%D1%8B%D1%85%20%D1%82%D0%B8%D0%BF%D0%BE%D0%B2-Todo-green)](https://github.com/IUTechSupp/SodiumDIA/issues/7)

Строка — последовательность слов. У каждого слова есть цвет текста и цвет фона, которые могут изменяться при изменении свойств элемента интерфейса.

В первую очередь нужны три типа строк:

- **Unselectable** — статичная строка, которую нельзя выбрать

- **Selectable** — строка, которую можно выбрать

- **Horizontal** — строка, которую можно выбрать, содержащая несколько слов, между которыми также можно переключаться



Обработчик интерфейса хранит в себе упорядоченный список Selectable и Horizontal строк. При нажатии кнопок “Вверх” или “Вниз” происходит смена выбранной строки. Unselectable строки при этом игнорируются.



Selectable и Horizontal строки должны обрабатывать следующие события:

...
#define ST7735_RESET_PIN (GPIO_PIN_3)
...
extern void ST7735_Select();
extern void ST7735_Deselect();
extern void ST7735_SendCommand(uint8_t cmd);
extern void ST7735_SendData(uint8_t data);
extern void ST7735_SendByte(uint8_t data);
extern void ST7735_SetColAddr(uint16_t cStart, uint16_t cStop);
extern void ST7735_SetRowAddr(uint16_t rStart, uint16_t rStop);
